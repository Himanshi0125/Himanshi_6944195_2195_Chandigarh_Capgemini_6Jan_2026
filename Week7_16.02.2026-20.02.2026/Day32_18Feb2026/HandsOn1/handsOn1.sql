...
SELECT agent_name, agent_code, phone_no FROM agents WHERE agent_code = 'A003';
...
SELECT ord_num,ord_amount,ord_date,cust_code, agent_code FROM orders WHERE ord_amount>2500;

SELECT AVG(ord_amount),COUNT(agent_code),agent_code FROM orders 
GROUP BY agent_code
HAVING AVG(ord_amount)=
(SELECT AVG(ord_amount) FROM orders WHERE agent_code='A008');
...
SELECT ord_num,ord_amount,ord_date, cust_code, agent_code FROM orders
WHERE agent_code=
(SELECT DISTINCT agent_code FROM orders WHERE cust_code='C00005');
