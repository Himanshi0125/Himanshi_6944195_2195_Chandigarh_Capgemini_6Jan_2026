...
namespace LibraryMVC.Controllers
{
    ...
    {
        private readonly LibraryDb2Context _context;

        public BooksController(LibraryDb2Context context)
        {
            _context = context;
        }
        ...
        {
            var libraryDb2Context = _context.Books.Include(b => b.Author);
            return View(await libraryDb2Context.ToListAsync());
        }
