    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                //     "Data Source=DESKTOP-USKTK4R\\SQLEXPRESS;Initial Catalog=EmployeeDB;Integrated Security=True";
                string connectionString ="Server=localhost;Database=EmployeeDB;User Id=sa;Password=StrongPassword@123;TrustServerCertificate=True;";
